      ...
      <div className="absolute inset-x-0 top-[104px] z-10 mx-auto max-w-7xl px-6 -translate-x-6">
        ...
        <div className="mt-[29px] flex items-start justify-between gap-4">
          <div className="translate-x-[2px] translate-y-[13px]">
            ...
            >
              <span className="bg-[rgb(155,71,10)] pt-0 pb-[2px] pl-[2px] -ml-[2px]">Want</span> to be a founder?
            </h2>
            <p
            ...
            >
              <span className="bg-[rgb(155,71,10)] pt-0 pb-[2px] pl-[2px] -ml-[2px]">Start</span> your own business?
            </p>
          </div>
