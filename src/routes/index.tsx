  ...
  return (
    <section id="top" className="relative h-[78vh] min-h-[560px] w-full overflow-hidden">
      <img
        ...
        className="absolute -top-[83px] left-0 right-0 h-[calc(100%+83px)] w-full object-cover object-[60%_center] brightness-125"
      />
      ...
      <div className="absolute inset-x-0 top-[104px] z-10 mx-auto max-w-7xl px-6 -translate-x-6">
        ...
        <div className="mt-[29px] flex items-start justify-between gap-4">
          <div>
            <h2 className="text-[1.23rem] font-[780] uppercase tracking-[0.08em] text-foreground">
              Want to be a founder?
            </h2>
            <p className="mt-1 text-[1.23rem] font-[780] uppercase tracking-[0.08em] text-foreground">
              Start your own business?
            </p>
          </div>
          <div className="flex items-center gap-2.5 translate-y-[26px] -translate-x-[42px]">
            <img
              src={launchflyMark}
              alt=""
              aria-hidden
