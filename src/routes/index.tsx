...
function Banner() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col items-center justify-end gap-3 px-6 pt-6 pb-[40vh] text-center md:hidden md:min-h-0">
...
function Hero() {
  return (
    ...
    <section className="relative px-6 -mt-[38vh] md:-mt-[187px]">
