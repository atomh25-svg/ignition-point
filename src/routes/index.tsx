  ...
  return (
    ...
    >
      <img
        ...
        className="absolute -top-[70px] h-[calc(100%+70px)] object-cover object-[60%_center] brightness-125 contrast-[1.1] translate-x-[10px] translate-y-[20px] scale-[1.44] md:scale-[1.2]"
