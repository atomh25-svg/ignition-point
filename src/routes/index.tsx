  ...
  return (
    ...
    >
      <img
        ...
        className="absolute top-0 h-full md:-top-[70px] md:h-[calc(100%+70px)] object-cover object-[60%_center] brightness-125 contrast-[1.1] translate-x-[10px] translate-y-[-7px] scale-[1.44] md:translate-y-[10px] md:scale-100"
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col items-center justify-end gap-[6vh] px-6 pt-6 pb-[calc(40vh+52px)] text-center md:hidden md:min-h-0">
        <span className="mt-[-14px] inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-3 py-1 text-[11px] text-muted-foreground backdrop-blur">
