      ...
      <div className="absolute inset-x-0 top-[104px] z-10 mx-auto max-w-7xl px-6 -translate-x-6">
        ...
        <div className="mt-[29px] flex items-start justify-between gap-4">
          <div className="translate-x-[2px] translate-y-[8px]">
            ...
            >
              <span className="bg-black px-1.5 py-0.5 rounded-sm">Want</span> to be a founder?
            </h2>
            <p
            ...
            >
              <span className="bg-black px-1.5 py-0.5 rounded-sm">Start</span> your own business?
            </p>
          </div>
