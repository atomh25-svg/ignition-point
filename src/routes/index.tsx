  ...
  return (
    <section id="top" className="relative h-[78vh] min-h-[560px] w-full overflow-hidden">
      <img
        ...
        className="absolute -top-[103px] left-0 right-0 h-[calc(100%+103px)] w-full object-cover object-[60%_center] brightness-125"
      />
      ...
      {/* Giant "LaunchFly" wordmark centered behind the overlay text.
          ...
          clicks. */}
      <div className="pointer-events-none absolute inset-x-0 top-1/2 z-[5] -translate-y-[calc(50%-5px)] px-6 text-center">
        <h2
...
function Hero() {
  return (
    <section className="relative -mt-[270px] px-6">
