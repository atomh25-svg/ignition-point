...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "LaunchFly — The first step from impulse to reality" },
      { name: "description", content: "LaunchFly helps you find your business idea, shape it into a real offer, build the first version, and move toward your first customer." },
      { property: "og:title", content: "LaunchFly — The first step from impulse to reality" },
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-5xl px-6 pt-20 pb-32 text-center">
            <div className="flex flex-row items-center justify-center gap-2.5 animate-float-up">
              ...
              <span className="font-display font-semibold tracking-tight text-3xl md:text-4xl text-gradient">LaunchFly</span>
            </div>
            ...
            <p className="mt-8 max-w-2xl mx-auto text-lg text-muted-foreground animate-float-up" style={{ animationDelay: "0.2s" }}>
              LaunchFly helps you find your business idea, shape it into a real offer, build the first version,
