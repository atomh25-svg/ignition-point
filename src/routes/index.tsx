...
function Banner() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col items-center justify-end gap-[6vh] px-6 pt-6 pb-[calc(40vh+15px)] text-center md:hidden md:min-h-0">
...
function Hero() {
  return (
    ...
    <section className="relative px-6 -mt-[calc(36vh+15px)] md:-mt-[187px]">
