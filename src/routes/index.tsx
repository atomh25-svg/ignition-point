  ...
  return (
    <section id="top" className="relative h-[78vh] min-h-[560px] w-full overflow-hidden">
      ...
      {/* Giant "LaunchFly" wordmark centered behind the overlay text.
          ...
          clicks. */}
      <div className="pointer-events-none absolute inset-x-0 top-1/2 z-[5] -translate-y-[calc(50%-81px)] -translate-x-[9px] px-6 text-center">
        <div className="relative inline-block">
          ...
          <h2
            ...
            style={{
              ...
              transform: "translateY(3px) scale(0.93, 1.01)",
